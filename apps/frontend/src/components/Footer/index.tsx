...
// The GitHub mark as an inline SVG: the footer is a server component, and
// @ant-design/icons needs a React context, which only a client component has
...
/**
 * The version comes from the server's settings when the admin is signed in;
  ...
  return (
    <footer className={styles.footer}>
      <a
        ...
        href={projectWebsitePage(locale, '/docs')}
        target="_blank"
        rel="noopener noreferrer"
      >
        {t('docs')}
      </a>
      <a className={styles.link} href={PROJECT_REPOSITORY_URL} target="_blank" rel="noopener noreferrer">
        <GithubMark />
        GitHub
      </a>
