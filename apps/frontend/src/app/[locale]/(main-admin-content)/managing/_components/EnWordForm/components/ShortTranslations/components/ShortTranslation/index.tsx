...
export const ShortTranslation: React.FC<ShortTranslationP> = ({
  ...
  const onChangeVariantOfWord = (v: string, ind: number) => {
    setShortTranslation({
      ...shortTranslation,
      variants_of_words: shortTranslation.variants_of_words.map((w, i) => (i === ind ? v : w)),
    });
  };
  const addWord = () => {
    setShortTranslation({
      ...shortTranslation,
      variants_of_words: [...shortTranslation.variants_of_words, ''],
    });
  };
  return (
    <div className={styles.shortTranslation}>
      ...
      <div className={styles.variants_of_words}>
        ...
        {shortTranslation.variants_of_words.map((v, i) => (
