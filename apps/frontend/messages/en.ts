...
export default {
  errors: {
    ...
    [ErrorCodes.suggestion_doesnt_found]: 'The report was not found — it may have been deleted',
    [ErrorCodes.suggestion_queue_full]: 'The suggestion queue is full',
    [ErrorCodes.suggestion_invalid]: 'The proposed changes are malformed',
  ...
  suggestions: {
    intro:
      'Reader reports on the dictionary data, filed from the word pages of the website (no account needed, strictly rate-limited). Resolve a report after fixing the entry — your edit marks it "modified by you" and survives dataset updates — or dismiss it.',
    col_time: 'When',
    col_status: 'Status',
    col_headword: 'Word',
    col_kind: 'Kind',
    ...
    target_meaning_translation: 'translation',
    target_short_translation: 'short translation',
    action_apply: 'Apply',
    apply_confirm: 'Apply the proposed values to the dictionary?',
    applied: 'Applied — the entry is updated and marked as yours',
    status_new: 'new',
  ...
  history: {
    intro:
      'Every change made through the admin API, newest first. Import runs appear as one summary row. Rows older than AUDIT_RETENTION_DAYS (90 by default) are deleted.',
    col_time: 'When',
    col_action: 'Action',
    col_entity: 'What',
    col_headword: 'Word / field',
    col_changes: 'Changes',
    filter_entity: 'Entity',
    filter_action: 'Action',
    filter_search: 'Word or field prefix…',
    action_create: 'created',
    action_update: 'updated',
    action_delete: 'deleted',
    action_import: 'import',
    entity_word: 'word',
    entity_word_form: 'word form',
    entity_meaning: 'meaning',
    entity_meaning_translation: 'meaning translation',
    entity_short_translation: 'short translation',
  ...
  import_dictionary: {
    ...
    en_saving_10: 'Saving meanings...',
    en_saving_11: 'Saving meaning translations...',
    en_saving_12: 'Saving short translations...',
    ...
    files_hint:
      'At least one .jsonl file is needed; every other file and the manifest are optional. The meanings, meaning translations and short translations are files of their own: a file of translations alone loads into a dictionary whose entries and meanings already exist',
    file_words: 'Words',
    file_phrasal_verbs: 'Phrasal verbs',
    file_grammar_patterns: 'Grammar patterns',
    file_phrases: 'Phrases',
    file_meanings: 'Meanings',
    file_meaning_translations_lang: 'Meaning translations: {language}',
    file_short_translations_lang: 'Short translations: {language}',
  ...
  bulk_request: {
    ...
    filter_has_model: 'Has source model',
