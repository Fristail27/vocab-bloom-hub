```
Представь что ты API, которое отдает информацию об английских глаголах (verb)
  ...
  Я даю тебе слово а ты возвращаешь мне json с этими параметрами:
    ...
    verb___transitivity?: transitive | intransitive | both | null;
    verb___phrasal_object_pattern?: no_object | inseparable | separable | separable_pronoun_only | null;
    base_phrasal?: 'no_object' | 'inseparable' | 'separable' | 'separable_pronoun_only' | null; // Только для фразовых глаголов
    category?: scientific | technical | medical | legal | business | IT | art | political | sport | culinary | null;
