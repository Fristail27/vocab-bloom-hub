...
export const PUBLIC_RESPONSES: Record<string, PublicResponseSpecT> = {
  ...
  PublicWordsController_byHeadword: { type: 'PublicHeadwordV1ResT', errors: [404, 429] },
  PublicWordsController_meanings: { type: 'PublicHeadwordMeaningsV1ResT', errors: [404, 429] },
  PublicWordsController_translations: { type: 'PublicHeadwordTranslationsV1ResT', errors: [400, 404, 429] },
  PublicWordsController_forms: { type: 'PublicHeadwordFormsV1ResT', errors: [404, 429] },
