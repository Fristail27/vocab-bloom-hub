...
/** Filters of the admin meaning translations listing (GET /api/en/meaning-translations) */
export class ListMeaningTranslationsQueryDTO extends PaginationQueryDTO {
