...
export type AddWordFormResT = { success: boolean } | ErrorResT;
...
export type AddShortTranslationResT = { success: boolean } | ErrorResT;
...
export type AddMeaningResT = { success: boolean } | ErrorResT;
...
export type AddMeaningTranslationResT = { success: boolean } | ErrorResT;
