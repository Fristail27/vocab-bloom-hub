export default {
  ...
  home: {
    ...
    hero_text:
      'Vocab Bloom Hub is a self-hosted English dictionary — 300 000 entries with meanings, examples, inflected forms and translations into Russian, Spanish, French, German, Portuguese and Chinese — behind a public read-only API, with SDKs, an admin UI and a published dataset. One command to install, MIT for the code, CC BY 4.0 for the data.',
  ...
  word: {
    ...
    transitivity_transitive: 'transitive',
    transitivity_intransitive: 'intransitive',
    transitivity_both: 'transitive and intransitive',
    phrasal_no_object: 'phrasal, no object',
    phrasal_inseparable: 'phrasal, inseparable',
    phrasal_separable: 'phrasal, separable',
    phrasal_separable_pronoun_only: 'phrasal, separable with pronouns only',
    patterns: 'Patterns',
    ...
    report_entry: 'Which entry?',
    report_entry_any: 'The whole word',
    report_message: 'What is wrong',
    report_placeholder: 'What is wrong and, ideally, what would be right (at least 10 characters)…',
    report_send: 'Send the report',
    report_sending: 'Sending…',
    report_cancel: 'Cancel',
    report_done: 'Thank you — the report is in the moderation queue.',
    ...
    suggest_edit_hint:
      'Correct the values below — only what you change is sent. The owner of this dictionary sees the proposal as a diff and can apply it in one click.',
    suggest_edit_send: 'Suggest the changes',
    suggest_edit_done: 'Thank you — the proposal is in the moderation queue.',
    suggest_edit_nothing: 'Nothing changed yet — edit a value first.',
    suggest_meaning: 'Meaning {n}',
    suggest_translation: 'Translation',
    suggest_short_translations: 'Short translations',
    suggest_field_description: 'Description',
    suggest_field_transcription: 'Transcription',
    suggest_field_title: 'Title',
