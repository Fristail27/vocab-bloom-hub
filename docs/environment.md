...
| `API_INTERNAL_URL`         | no                | — (`NEXT_PUBLIC_BASE_API_URL`)     | frontend | Runtime address the frontend process itself uses for server-side rendering — the API reached directly, without the proxy: `http://server:3010/api` in `docker-compose.yml`. Never sent to the browser.                                                                                                                                                                                                                                                                             |
