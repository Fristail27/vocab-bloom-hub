...
| `NEXT_PUBLIC_SITE_URL`     | no                | `http://localhost:3020`                                         | site           | The public origin of the website, for the absolute URLs of its `sitemap.xml` and `robots.txt`. Inlined at build time.                                                                                                                                                                                                                                                                                                                                                                                                                 |
